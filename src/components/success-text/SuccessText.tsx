...
const SuccessText = (props: any) => {
    ...
    // </div>: <div></div>;
    return <div className='ans-pop-up' style={{margin: "auto", display: "flex", width: "300px", height: "10px", justifyContent: "center", marginTop: "4px", background: ""}}>
        <p className='ans-pop-up-text' style={{fontSize: "3.0em", textAlign: "center"}}>{props.word}</p>
    </div>;
}
