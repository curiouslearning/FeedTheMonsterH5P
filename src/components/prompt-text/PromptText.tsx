...
const PromptText = (props: any) => {
    ...
    return <div onClick={playAudio} className='ans-pop-up' style={{margin: "auto", display: "flex", width: "100px", height: "50px", justifyContent: "center", marginTop: "20px", background: "grey"}}>
