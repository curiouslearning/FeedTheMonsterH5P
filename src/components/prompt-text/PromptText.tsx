...
const PromptText = (props: any) => {
    ...
    return <div onClick={playAudio} className='ans-pop-up' style={{...{margin: "auto", marginTop:"-20px", display: "flex", backgroundImage: `url(${getImagePath()+'promptTextBg.png'})`, width: "163px", height: "152px", backgroundSize: "contain", justifyContent: "center", alignItems: "center"}, ...{opacity: opacity}}}>
